...
<div class="not-prose my-8 rounded-lg border border-gold bg-cream px-6 py-5">
  ...
  <ul class="space-y-2 text-sm text-brown">
    <li class="flex gap-2"><span class="mt-0.5 font-bold text-olive">✓</span><span><strong>Full Bali retirement costs $2,500–$4,000/month all-in:</strong> Private villa, housekeeper, private healthcare, quality dining. Compared to $6,000–$12,000+ for a similar coastal Australian lifestyle.</span></li>
    <li class="flex gap-2"><span class="mt-0.5 font-bold text-olive">✓</span><span><strong>Buying beats renting over 5 years:</strong> $2,500/month rent = $150,000 gone with zero asset. $350k villa with 67% occupancy = ~$34,000/year in rental income that covers your living costs.</span></li>
    <li class="flex gap-2"><span class="mt-0.5 font-bold text-olive">✓</span><span><strong>Second Home Visa:</strong> IDR 2B property or bank deposit (~$125k USD) unlocks 5+5 years of legal stay with spouse and dependents. No work permitted.</span></li>
    <li class="flex gap-2"><span class="mt-0.5 font-bold text-olive">✓</span><span><strong>Golden Visa:</strong> USD $350,000+ investment → 5 to 10 year visa. Higher tier, still bedding in administratively but the right long-term option for serious buyers.</span></li>
    <li class="flex gap-2"><span class="mt-0.5 font-bold text-olive">✓</span><span><strong>Three risks to manage:</strong> Leasehold structure quality (non-negotiable on legal review), management dependency (bad operator destroys yield), and building maintenance in a tropical climate.</span></li>
  </ul>
</div>
