...
<div class="not-prose my-8 rounded-lg border border-gold bg-cream px-6 py-5">
  ...
  <ul class="space-y-2 text-sm text-brown">
    <li class="flex gap-2"><span class="mt-0.5 font-bold text-olive">✓</span><span><strong>Median entry is $290,000:</strong> Based on 511 active listings across 80 developers. Quality stock in strong locations starts around $250,000. Premium Canggu and Seminyak starts at $380,000.</span></li>
    <li class="flex gap-2"><span class="mt-0.5 font-bold text-olive">✓</span><span><strong>Average gross yield is 10.6%:</strong> Canggu tops at 14.8%. Compare to Australia (3–4%), UK (3–4%), Dubai (6–7%). Bali's yield premium is real and demand-led.</span></li>
    <li class="flex gap-2"><span class="mt-0.5 font-bold text-olive">✓</span><span><strong>2026 is better than 2019 for certainty:</strong> Developers have track records. Notaries are established. You can underwrite a deal on real occupancy data before you commit.</span></li>
    <li class="flex gap-2"><span class="mt-0.5 font-bold text-olive">✓</span><span><strong>3 deal-killers to avoid:</strong> Wrong zoning (agricultural land cannot be rented legally), missing PBG/SLF permits, and weak lease renewal terms.</span></li>
    <li class="flex gap-2"><span class="mt-0.5 font-bold text-olive">✓</span><span><strong>2026 compliance is now enforced:</strong> All short-term rental listings require a valid NIB and KBLI 55203 classification. Platforms are actively delisting non-compliant properties.</span></li>
  </ul>
</div>
