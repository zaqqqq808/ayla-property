...
<div class="not-prose my-8 rounded-lg border border-gold bg-cream px-6 py-5">
  ...
  <ul class="space-y-2 text-sm text-brown">
    <li class="flex gap-2"><span class="mt-0.5 font-bold text-olive">✓</span><span><strong>A PT PMA is not always necessary:</strong> For a single leasehold villa under $400k with a sub-25yr hold horizon, a notarised leasehold is simpler, cheaper, and delivers everything you need.</span></li>
    <li class="flex gap-2"><span class="mt-0.5 font-bold text-olive">✓</span><span><strong>2025 capital change:</strong> Paid-up capital reduced from IDR 10B ($630k) to IDR 2.5B ($155k). But the Total Investment Plan threshold of IDR 10B remains. Property value counts toward it.</span></li>
    <li class="flex gap-2"><span class="mt-0.5 font-bold text-olive">✓</span><span><strong>Setup cost: $2,000–$5,000 one-time.</strong> Annual compliance: $500–$1,500. These costs exist even before you generate income, so factor them into your buy decision.</span></li>
    <li class="flex gap-2"><span class="mt-0.5 font-bold text-olive">✓</span><span><strong>You DO need it for:</strong> 2+ properties, formal hospitality operations, 30+ year holds, or properties above $600k–$800k where BPN-registered title justifies the overhead.</span></li>
    <li class="flex gap-2"><span class="mt-0.5 font-bold text-olive">✓</span><span><strong>KBLI 55203 is the code that matters:</strong> Vila accommodation (under 25 units). Getting the KBLI classification wrong at setup creates expensive compliance problems later.</span></li>
  </ul>
</div>
...
For the broader legal framework that sits around property investment in Bali, our [Indonesia Foreign Investor Checklist 2026](/guides/indonesia-foreign-investor-checklist-2026/) covers the regulatory environment in detail. The [foreigners buying guide](/guides/foreigners-buying-property-bali/) walks through the leasehold alternative for investors who do not need the full PT PMA structure.

If you want to talk through whether a PT PMA makes sense for your specific situation, book a 30-minute call: [calendly.com/ayla-teamoperations/30min](https://calendly.com/ayla-teamoperations/30min). I would rather help you make the right call upfront than fix an expensive mistake later.
