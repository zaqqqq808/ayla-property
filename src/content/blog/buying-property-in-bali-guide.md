...
- **The Entry Point:** The median investment villa sits at $290,000. Prime areas (Canggu, Seminyak) range from $380,000 to $420,000. Entry-level stock starts at $165,000 in East Bali.
- **The Yield Premium:** Bali averages 10.6% gross yield, with Canggu reaching 14.8%. That compares to 6 to 7% in Dubai and 3 to 4% in Sydney.
- **Regulatory Enforcement:** Compliance is no longer optional. As of March 2026, all short-term rental listings require a verified NIB business licence and correct KBLI classification (KBLI 55203 for villas) to avoid delisting from Airbnb, Booking.com and Expedia.
- **Transaction Timeline:** Legal property transfers take 4 to 8 weeks and require independent PBG (building permit) and SLF (Sertifikat Laik Fungsi / Certificate of Functional Eligibility) audits before handover.
